 ...
 * SwapForGasFragment
 *
 * Handles swapping any token to SCRT for gas
 */
class SwapForGasFragment : Fragment() {

    companion object {
        private const val TAG = "SwapForGasFragment"

        @JvmStatic
        fun newInstance(): SwapForGasFragment = SwapForGasFragment()
    }
    ...
    private var listener: SwapForGasListener? = null

    override fun onAttach(context: Context) {
        super.onAttach(context)
        listener = when {
            parentFragment is SwapForGasListener -> parentFragment as SwapForGasListener
            context is SwapForGasListener -> context
            else -> null
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_swap_for_gas, container, false)
    }
