...
@Composable
fun <T : ModalBottomSheetState> EarthScreenModalBottomSheet(
    state: T?,
    sheetGesturesEnabled: Boolean = true,
    properties: ModalBottomSheetProperties = ModalBottomSheetDefaults.properties,
    sheetState: SheetState = rememberScreenModalBottomSheetState(),
    shape: Shape = EarthModalBottomSheetDefaults.SheetShape,
    containerColor: Color = EarthModalBottomSheetDefaults.ContainerColor,
    dragHandle: @Composable (() -> Unit)? = { EarthModalBottomSheetDragHandle() },
    ...
    SideEffect {
        ...
        hostWindow?.setWindowAnimations(R.style.EarthBottomSheetScrimAnimation)
    }
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun EarthScreenModalBottomSheet(
    ...
    SideEffect {
        val window =
            generateSequence(view.parent) { (it as? View)?.parent }
                ...
                .firstOrNull()
                ?.window
        window?.setWindowAnimations(R.style.EarthBottomSheetDialogAnimation)
    }
}
