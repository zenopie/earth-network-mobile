...
class PassportScannerFragment : Fragment(), MRZInputFragment.MRZInputListener {
    ...
    companion object {
        ...
        // Shown by the confirmation sheet and checked against the balance. They
        // reference Personhood so the displayed numbers cannot drift from the
        // ones actually broadcast — which is exactly what happened when this
        // file kept its own copies.
        private val REGISTER_GAS_LIMIT = Personhood.REGISTER_GAS_LIMIT
        private val REGISTER_FEE_UERTH = Personhood.REGISTER_FEE_UERTH.toLong()
